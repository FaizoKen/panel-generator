...
var init_twemoji_esm = __esm({
  "node_modules/twemoji/dist/twemoji.esm.js"() {
    twemoji = function() {
      "use strict";
      var twemoji2 = { base: "https://twemoji.maxcdn.com/v/14.0.1/", ext: ".png", size: "72x72", className: "emoji", convert: { fromCodePoint, toCodePoint }, onerror: function onerror() {
        if (this.parentNode) {
...
var require_Twemoji = __commonJS({
  "node_modules/react-twemoji/lib/Twemoji/index.js"(exports) {
    ...
    var _twemoji = _interopRequireDefault((init_twemoji_esm(), __toCommonJS(twemoji_esm_exports)));
