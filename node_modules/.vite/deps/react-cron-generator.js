        ...
        var __webpack_modules__ = {
          ...
          980: (
            ...
            (__unused_webpack_module, exports2, __webpack_require__2) => {
              ...
              var bg_1 = __webpack_require__2(431);
          ...
          431: (
            ...
            (__unused_webpack_module, exports2) => {
              ...
              var bg = function() {
                ...
                bg2.prototype.atX0SecondsPastTheMinuteGt20 = function() {
                  return null;
                };
                bg2.prototype.atX0MinutesPastTheHourGt20 = function() {
                  return null;
                };
                bg2.prototype.commaMonthX0ThroughMonthX1 = function() {
                  return null;
                };
                bg2.prototype.commaYearX0ThroughYearX1 = function() {
                  return null;
                };
                bg2.prototype.use24HourTimeFormatByDefault = function() {
                  return true;
                };
                bg2.prototype.everyMinute = function() {
                  return "всяка минута";
                };
                bg2.prototype.everyHour = function() {
                  return "всеки час";
                };
                bg2.prototype.anErrorOccuredWhenGeneratingTheExpressionD = function() {
                  return "Възникна грешка при генериране на описанието на израза. Проверете синтаксиса на cron израза.";
                };
                bg2.prototype.atSpace = function() {
                  return "В ";
                };
                bg2.prototype.everyMinuteBetweenX0AndX1 = function() {
                  return "Всяка минута от %s до %s";
                };
                bg2.prototype.at = function() {
                  return "В";
                };
                bg2.prototype.spaceAnd = function() {
                  return " и";
                };
                bg2.prototype.everySecond = function() {
                  return "всяка секунда";
                };
                bg2.prototype.everyX0Seconds = function(s) {
                  return "всеки %s секунди";
                };
                bg2.prototype.secondsX0ThroughX1PastTheMinute = function() {
                  return "секунди от %s до %s";
                };
                bg2.prototype.atX0SecondsPastTheMinute = function(s) {
                  return "%s-".concat(getNumberEnding(s, "ж"), " секунда");
                };
                bg2.prototype.everyX0Minutes = function(s) {
                  return "всеки %s минути";
                };
                bg2.prototype.minutesX0ThroughX1PastTheHour = function() {
                  return "минути от %s до %s";
                };
                bg2.prototype.atX0MinutesPastTheHour = function(s) {
                  return "%s-".concat(getNumberEnding(s, "ж"), " минутa");
                };
                bg2.prototype.everyX0Hours = function(s) {
                  return "всеки %s часа";
                };
                bg2.prototype.betweenX0AndX1 = function() {
                  return "от %s до %s";
                };
                bg2.prototype.atX0 = function() {
                  return "в %s";
                };
                bg2.prototype.commaEveryDay = function() {
                  return ", всеки ден";
                };
                bg2.prototype.commaEveryX0DaysOfTheWeek = function(s) {
                  return getPhraseByPlural(s, [", всеки %s ден от седмицата", ", всеки %s дена от седмицата"]);
                };
                bg2.prototype.commaX0ThroughX1 = function(s) {
                  return ", от %s до %s";
                };
                bg2.prototype.commaAndX0ThroughX1 = function(s) {
                  return " и от %s до %s";
                };
                bg2.prototype.first = function(s) {
                  return getPhraseByDayOfWeek(s, ["первият", "первата"]);
                };
                bg2.prototype.second = function(s) {
                  return getPhraseByDayOfWeek(s, ["вторият", "втората"]);
                };
                bg2.prototype.third = function(s) {
                  return getPhraseByDayOfWeek(s, ["третият", "третата"]);
                };
                bg2.prototype.fourth = function(s) {
                  return getPhraseByDayOfWeek(s, ["четвертият", "четвертата"]);
                };
                bg2.prototype.fifth = function(s) {
                  return getPhraseByDayOfWeek(s, ["петият", "петата"]);
                };
                bg2.prototype.commaOnThe = function(s) {
                  return ", ";
                };
                bg2.prototype.spaceX0OfTheMonth = function() {
                  return " %s на месеца";
                };
                bg2.prototype.lastDay = function() {
                  return "последният ден";
                };
                bg2.prototype.commaOnTheLastX0OfTheMonth = function(s) {
                  return getPhraseByDayOfWeek(s, [", в последният %s от месеца", ", в последната %s отмесеца"]);
                };
                bg2.prototype.commaOnlyOnX0 = function(s) {
                  return ", %s";
                };
                bg2.prototype.commaAndOnX0 = function() {
                  return " и %s";
                };
                bg2.prototype.commaEveryX0Months = function(s) {
                  return " всеки %s месеца";
                };
                bg2.prototype.commaOnlyInMonthX0 = function() {
                  return ", %s";
                };
                bg2.prototype.commaOnlyInX0 = function() {
                  return ", в %s";
                };
                bg2.prototype.commaOnTheLastDayOfTheMonth = function() {
                  return ", в последният ден на месеца";
                };
                bg2.prototype.commaOnTheLastWeekdayOfTheMonth = function() {
                  return ", в последния делничен ден от месеца";
                };
                bg2.prototype.commaDaysBeforeTheLastDayOfTheMonth = function(s) {
                  return getPhraseByPlural(s, [", %s ден преди края на месеца", ", %s дена преди края на месеца"]);
                };
                bg2.prototype.firstWeekday = function() {
                  return "първият делничен ден";
                };
                bg2.prototype.weekdayNearestDayX0 = function() {
                  return "най-близкият делничен ден до %s число";
                };
                bg2.prototype.commaOnTheX0OfTheMonth = function() {
                  return ", на %s число от месеца";
                };
                bg2.prototype.commaEveryX0Days = function(s) {
                  return getPhraseByPlural(s, [", всеки %s ден", ", всеки %s дена"]);
                };
                bg2.prototype.commaBetweenDayX0AndX1OfTheMonth = function(s) {
                  var _a;
                ...
                bg2.prototype.commaOnDayX0OfTheMonth = function(s) {
                  return ", на %s-".concat(getNumberEnding(s, "ср"), " число от месеца");
                };
                bg2.prototype.commaEveryX0Years = function(s) {
                  return getPhraseByPlural(s, [", всяка %s година", ", всеки %s години"]);
                };
                bg2.prototype.commaStartingX0 = function() {
                  return ", започвайки %s";
                };
                bg2.prototype.daysOfTheWeek = function() {
                  return ["неделя", "понеделник", "вторник", "сряда", "четвъртък", "петък", "събота"];
                };
                bg2.prototype.monthsOfTheYear = function() {
...
var MinutesCron = (props) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well" }, { children: [props.translate("Every"), " ", (0, import_jsx_runtime.jsx)("input", { type: "Number", onChange, value, min: 1, max: 60 }), " ", props.translate("minute(s)")] }));
};
var MinutesSelect = (props) => {
  const buildOptions = () => {
    let options = [];
    for (let i = 0; i < 60; i++) {
      options.push((0, import_jsx_runtime.jsx)("option", Object.assign({ id: i.toString() }, { children: (i < 10 ? "0" : "") + i }), i));
    }
    return options;
  };
  return (0, import_jsx_runtime.jsx)("select", Object.assign({ disabled: props.disabled === true ? true : false, className: "minutes", onChange: props.onChange, value: props.value }, { children: buildOptions() }));
};
var HourSelect = (props) => {
  const buildOptions = () => {
    let options = [];
    for (let i = 0; i < 24; i++) {
      options.push((0, import_jsx_runtime.jsx)("option", Object.assign({ id: i.toString() }, { children: (i < 10 ? "0" : "") + i }), i));
  ...
  return (0, import_jsx_runtime.jsx)("select", Object.assign({ disabled: props.disabled === true ? true : false, className: "hours", onChange: props.onChange, value: props.value }, { children: buildOptions() }));
};
var DailyCron = (props) => {
  const [state, setState] = (0, import_react.useState)({ hour: 0, minute: 0, every: false });
  ...
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "tab-pane" }, { children: [(0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "radio", onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: true }));
    props.onChange();
  }, value: "1", name: "DailyRadio", checked: state.every }), (0, import_jsx_runtime.jsx)("span", { children: translateFn("Every") }), (0, import_jsx_runtime.jsx)("input", { disabled: !state.every, type: "Number", maxLength: 2, onChange: onDayChange, value: props.value[3].split("/")[1] ? props.value[3].split("/")[1] : "" }), (0, import_jsx_runtime.jsx)("span", { children: translateFn("day(s)") })] })), (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: false }));
    props.onChange(["0", props.value[1], props.value[2], "?", "*", "MON-FRI", "*"]);
  }, type: "radio", value: "2", name: "DailyRadio", checked: !state.every }), (0, import_jsx_runtime.jsx)("span", { children: translateFn("Every week day") })] })), (0, import_jsx_runtime.jsx)("span", { children: translateFn("Start time") }), (0, import_jsx_runtime.jsx)(HourSelect, { onChange: onAtHourChange, value: props.value[2] }), (0, import_jsx_runtime.jsx)(MinutesSelect, { onChange: onAtMinuteChange, value: props.value[1] })] }));
};
var HourlyCron = (props) => {
  const [state, setState] = (0, import_react.useState)({ every: false });
  (0, import_react.useEffect)(() => {
  ...
  const translateFn = props.translate;
  return (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "tab-content" }, { children: (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "tab-pane active" }, { children: [(0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "radio", onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: true }));
    props.onChange(["0", "0", "0/1", "1/1", "*", "?", "*"]);
  }, checked: state.every }), (0, import_jsx_runtime.jsxs)("span", { children: [translateFn("Every"), " "] }), (0, import_jsx_runtime.jsx)("input", { disabled: !state.every, type: "Number", onChange: onHourChange, value: props.value[2].split("/")[1] ? props.value[2].split("/")[1] : "" }), (0, import_jsx_runtime.jsx)("span", { children: translateFn("hour") }), (0, import_jsx_runtime.jsx)("input", { disabled: !state.every, type: "Number", onChange: onMinuteChange, value: props.value[1] }), (0, import_jsx_runtime.jsx)("span", { children: translateFn("minute(s)") })] })), (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "well well-small margin-right-0 margin-left-0" }, { children: (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "text_align_right", style: { width: "100%" } }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "radio", onChange: (e) => {
    setState({ every: false });
    props.onChange();
  }, checked: !state.every }), (0, import_jsx_runtime.jsx)("span", Object.assign({ className: "" }, { children: translateFn("At") })), (0, import_jsx_runtime.jsx)(HourSelect, { disabled: state.every, onChange: onAtHourChange, value: props.value[2] }), (0, import_jsx_runtime.jsx)(MinutesSelect, { disabled: state.every, onChange: onAtMinuteChange, value: props.value[1] })] })) }))] })) }));
};
var WeeklyCron = (props) => {
  const onAtHourChange = (e) => {
    let val = props.value;
    val[0] = "0";
    val[2] = `${e.target.value}`;
  ...
  const translateFn = props.translate;
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "container-fluid" }, { children: [(0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small row" }, { children: [(0, import_jsx_runtime.jsx)("div", Object.assign({ className: "span6 col-sm-6" }, { children: (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "text_align_left" }, { children: [(0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "MON", onChange: onCheck, checked: props.value[5].search("MON") !== -1 ? true : false }), translateFn("Monday"), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "WED", onChange: onCheck, checked: props.value[5].search("WED") !== -1 ? true : false }), translateFn("Wednesday"), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "FRI", onChange: onCheck, checked: props.value[5].search("FRI") !== -1 ? true : false }), translateFn("Friday"), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "SUN", onChange: onCheck, checked: props.value[5].search("SUN") !== -1 ? true : false }), translateFn("Sunday")] })) })), (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "span6 col-sm-6" }, { children: [(0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "text_align_left" }, { children: [(0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "TUE", onChange: onCheck, checked: props.value[5].search("TUE") !== -1 ? true : false }), translateFn("Tuesday"), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "THU", onChange: onCheck, checked: props.value[5].search("THU") !== -1 ? true : false }), translateFn("Thursday"), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("input", { className: "min_height_auto", type: "checkbox", value: "SAT", onChange: onCheck, checked: props.value[5].search("SAT") !== -1 ? true : false }), translateFn("Saturday")] })), (0, import_jsx_runtime.jsx)("br", {}), (0, import_jsx_runtime.jsx)("br", {})] }))] })), translateFn("Start time"), (0, import_jsx_runtime.jsx)(HourSelect, { onChange: onAtHourChange, value: props.value[2] }), (0, import_jsx_runtime.jsx)(MinutesSelect, { onChange: onAtMinuteChange, value: props.value[1] })] }));
};
var MonthlyCron = (props) => {
  const [state, setState] = (0, import_react.useState)({ hour: 0, minute: 0, every: "" });
  (0, import_react.useEffect)(() => {
    let every;
    if (props.value[3] === "L") {
      every = "2";
    ...
    setState(Object.assign(Object.assign({}, state), { every }));
  }, []);
  const onDayChange = (e) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "tab-pane" }, { children: [(0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "radio", onChange: (e) => {
    ...
    props.onChange(["0", props.value[1] === "*" ? "0" : props.value[1], props.value[2] === "*" ? "0" : props.value[2], "1", "1/1", "?", "*"]);
  }, value: "1", name: "MonthlyRadio", checked: state.every === "1" ? true : false }), translateFn("Day"), (0, import_jsx_runtime.jsx)("input", { readOnly: state.every !== "1", type: "number", value: props.value[3], onChange: onDayChange }), translateFn("of every month(s)")] })), (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: e.target.value }));
    props.onChange(["0", props.value[1] === "*" ? "0" : props.value[1], props.value[2] === "*" ? "0" : props.value[2], "L", "*", "?", "*"]);
  }, type: "radio", value: "2", name: "DailyRadio", checked: state.every === "2" ? true : false }), translateFn("Last day of every month")] })), (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: e.target.value }));
    props.onChange(["0", props.value[1] === "*" ? "0" : props.value[1], props.value[2] === "*" ? "0" : props.value[2], "LW", "*", "?", "*"]);
  }, type: "radio", value: "3", name: "DailyRadio", checked: state.every === "3" ? true : false }), translateFn("On the last weekday of every month")] })), (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well well-small" }, { children: [(0, import_jsx_runtime.jsx)("input", { type: "radio", onChange: (e) => {
    setState(Object.assign(Object.assign({}, state), { every: e.target.value }));
    props.onChange(["0", props.value[1] === "*" ? "0" : props.value[1], props.value[2] === "*" ? "0" : props.value[2], `L-${1}`, "*", "?", "*"]);
  }, value: "4", name: "MonthlyRadio", checked: state.every === "4" ? true : false }), (0, import_jsx_runtime.jsx)("input", { readOnly: state.every !== "4", type: "number", value: props.value[3].split("-").length && props.value[3].split("-")[1] ? props.value[3].split("-")[1] : "", onChange: onLastDayChange }), translateFn("day(s) before the end of the month")] })), translateFn("Start time"), (0, import_jsx_runtime.jsx)(HourSelect, { onChange: onAtHourChange, value: props.value[2] }), (0, import_jsx_runtime.jsx)(MinutesSelect, { onChange: onAtMinuteChange, value: props.value[1] })] }));
};
var CustomCron = (props) => {
  const onChange = (e) => {
    props.onChange(e.target.value.replace(/,/g, "!").split(" "));
  };
  const translateFn = props.translate;
  let val = props.value.toString().replace(/,/g, " ").replace(/!/g, ",");
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "well" }, { children: [translateFn("Expression"), " ", (0, import_jsx_runtime.jsx)("input", { type: "text", onChange, value: val })] }));
};
var HEADER = {
  MINUTES: "MINUTES",
  HOURLY: "HOURLY",
...
var defaultCron = "0 0 00 1/1 * ? *";
var Cron = (props) => {
  const [state, setState] = (0, import_react.useState)({ value: [], headers: loadHeaders(props.options), locale: props.locale ? props.locale : "en" });
  (0, import_react.useEffect)(() => {
    let newVal = "";
  ...
  const getHeaders = () => {
    return state.headers.map((d, index) => {
      return (0, import_jsx_runtime.jsx)("li", Object.assign({ className: "nav-item" }, { children: (0, import_jsx_runtime.jsx)("a", Object.assign({ className: `nav-link ${state.selectedTab === d ? "active" : ""}`, onClick: () => tabChanged(d) }, { children: translate(d) })) }), index);
    });
  };
  ...
  const getComponent = (tab) => {
    ...
    return (0, import_jsx_runtime.jsx)(CronComponent, { translate, value: state.value, onChange: onValueChange });
  };
  const translate = (key) => {
  ...
  return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "cron_builder" }, { children: [(0, import_jsx_runtime.jsx)("ul", Object.assign({ className: "nav nav-tabs" }, { children: getHeaders() })), (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "cron_builder_bordering" }, { children: state.selectedTab ? getComponent(state.selectedTab) : "Select a header" })), props.showResultText && (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "cron-builder-bg" }, { children: getVal() })), props.showResultCron && (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "cron-builder-bg" }, { children: state.value.toString().replace(/,/g, " ").replace(/!/g, ",") }))] }));
};
export {
  HEADER,
  Cron as default
};
//# sourceMappingURL=react-cron-generator.js.map
